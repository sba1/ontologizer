package ontologizer.gui.swt.cocao;
...
public class CocoaUIEnhancer {
    ...
    private static class MenuHookObject {
        final ISimpleAction about;
        final ISimpleAction pref;

        public MenuHookObject( ISimpleAction about, ISimpleAction pref ) {
            this.about = about;
            this.pref = pref;
        }
     ...
     */
    public void hookApplicationMenu( Display display, Listener quitListener, ISimpleAction aboutAction,
    		ISimpleAction preferencesAction ) {
