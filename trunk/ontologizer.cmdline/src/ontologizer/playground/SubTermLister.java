	...
	public static void main(String[] args)
	{
		try
		{
			...
			if (cmd.hasOption("h"))
			{
				...
				formatter.printHelp("java -jar SubTermLister.jar [options]", options);
				System.exit(0);
			}
			...
			{
				System.err.println(todo + " terms todo");
				todo--;
				...
				visitor.out = termOut;
				graph.walkToSinks(term.getID(),visitor);
				termOut.close();
			}
